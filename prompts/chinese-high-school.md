...
- **Tone drills**: synthesize with voice=zhiyu at rate=70 for individual tones and tone pairs
- **Phrases and sentences**: synthesize with voice=zhiyu at rate=80
- **Natural speed examples**: synthesize with voice=zhiyu at rate=100 (so students hear what real Chinese sounds like)
...
1. **Ni hao**: Greet in Chinese using phrases the student knows. Generate audio.
